...
Further, the automated approach
developed in Chapter \ref{chap:automated} is used to investigate
adjoint-based error estimation and mesh adaptation for several
examples in incompressible nonlinear elasticity.

As a further extension of the automated approach developed
in Chapter \ref{chap:automated}, Chapter \ref{chap:refine}.


Chapter \ref{chap:refine}

Chapter \ref{chap:vms}
...
\item Developing a novel approach for adjoint-based error
estimation for variational multiscale finite element methods.
\item Proving that two drasticallly distinct approaches for
