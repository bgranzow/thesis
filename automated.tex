...
an elasto-plastic constitutive model with a von-Mises yield
...
slab, solder balls, and bottom slab are modeled with the
...
equation \eqref{eq:aut_avg_vm_qoi} over three solder balls
at the maximal $x$ and $y$ coordinates, as shown in
Figure \ref{fig:aut_solder_geom}.
...
optimally. This may in part be explained by the fact that the
condition number of this problem scales as $\frac{1}{H^2}$.
...
decreases as the distance from the 3 QoI solder joints
